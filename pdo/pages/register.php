            ...
            <div class="p-5">
              ...
              <form action="" class="user"  method="post">
                <div class="form-group row">
                  ...
                  <div class="col-sm-6">
                    <input type="text" name="birthdate" class="form-control form-control-user" placeholder="Fecha Nacimiento" required>
                  </div>
                </div>
  ...
  <?php
    if ($_POST) {
      ...
      if (addStudents($names, $birthdate, $email, $password, $conn)) {
        // echo "<script> alert('El estudiante se agregó con éxito!');</script>";
